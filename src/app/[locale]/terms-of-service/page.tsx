...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Kaiju Alpha Wiki",
    description: "Read the Terms of Service for Kaiju Alpha Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Kaiju Alpha Wiki",
      description: "Terms and conditions for using Kaiju Alpha Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Kaiju Alpha Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Kaiju Alpha Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Kaiju Alpha Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Kaiju Alpha Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Kaiju Alpha". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and controls & builds</li>
              <li>Tier Lists and U-cell farming guides</li>
              <li>Kaiju Ability and world region information</li>
              <li>Kaiju and enemy guides</li>
              <li>Unlock walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Kaiju Alpha Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation and SULU KAKA or the official developers of Kaiju Alpha (SULU KAKA). We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Kaiju Alpha Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and SULU KAKA and/or the developers of Kaiju Alpha (SULU KAKA). We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Roblox game updates may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, KAIJU ALPHA WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Kaiju Alpha Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@kaijualpha.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@kaijualpha.wiki</a>
            </p>
            <p>
